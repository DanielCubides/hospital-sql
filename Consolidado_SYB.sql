...
INSERT INTO EPS (nombre,direccion,telefono,web,regimen)
VALUES('ColmГ©dica','Cra. 8 No. 38-31',5717568000,'www.colmedica.com','Contributivo');

INSERT INTO EPS (nombre,direccion,telefono,web,regimen)
VALUES('Humana Vivir','Clle 26 No 82вЂ“54',5717462040,'www.humanavivir.com.co','Contributivo');
...
INSERT INTO EPS (nombre,direccion,telefono,web,regimen)
VALUES('SOS','Av Las AmГ©ricas NВ° 23 N-55',5714898686,'www.sos.com.co','Contributivo');

INSERT INTO EPS (nombre,direccion,telefono,web,regimen)
VALUES('Golden Group S.A.','Carrera 11A # 98вЂ“50 Piso 3',5716910953,'www.EPSgoldengroup.com','Contributivo');
...
especialidad varchar(45) not null check(especialidad = 'Medicina General' or especialidad = 'GinecologГ­a' or especialidad = 'TraumatologГ­a' or especialidad = 'PediatrГ­a'),
...
VALUES ('DORIS DUQUE PINEDA','22139246',1320000,'Cr 12 No. 123 - 54',5716537462,3002113456,'2/02/1945','11/12/2000','11/12/2003','GinecologГ­a');

INSERT INTO MEDICOS (nombre,cedula,sueldo,direccion,telefono,celular,fecha_nacimiento,fecha_grado,fecha_ingreso,especialidad)
VALUES ('FATIMA MAZO JARAMILLO','43055231',1500000,'Cr 122 No. 10 - 48',5716535672,3112219956,'3/02/1970','11/12/2007','1/01/2012','GinecologГ­a');

INSERT INTO MEDICOS (nombre,cedula,sueldo,direccion,telefono,celular,fecha_nacimiento,fecha_grado,fecha_ingreso,especialidad)
VALUES ('MARIA VIRGELLINA BUSTAMANTE','3550661',2100000,'Cr 112 No. 83 - 84',5716899462,3117564026,'3/05/1960','1/02/1999','1/12/2001','TraumatologГ­a');
...
INSERT INTO MEDICOS (nombre,cedula,sueldo,direccion,telefono,celular,fecha_nacimiento,fecha_grado,fecha_ingreso,especialidad)
VALUES ('ORLANDO ZAPATA','70876033',1200000,'Cr 182 No. 18 - 47',5716787462,3129098456,'12/02/1979','10/03/1997','11/12/1998','TraumatologГ­a');

INSERT INTO MEDICOS (nombre,cedula,sueldo,direccion,telefono,celular,fecha_nacimiento,fecha_grado,fecha_ingreso,especialidad)
VALUES ('LUIS ARTURO ESTRADA','43523751',1820000,'Cr 192 No. 18 - 59',5716541621,3113094656,'11/09/1983','2/02/2007','1/12/2011','TraumatologГ­a');

INSERT INTO MEDICOS (nombre,cedula,sueldo,direccion,telefono,celular,fecha_nacimiento,fecha_grado,fecha_ingreso,especialidad)
VALUES ('BEATRIZ ESPINOSA','1241818',2150000,'Cr 2 No. 37 - 45',5717807462,3012000256,'6/08/1955','03/01/2008','1/12/2013','PediatrГ­a');

INSERT INTO MEDICOS (nombre,cedula,sueldo,direccion,telefono,celular,fecha_nacimiento,fecha_grado,fecha_ingreso,especialidad)
VALUES ('LUIS EDUARDO SUAREZ','71678440',3300000,'Cr 62 No. 12 - 53',5715417462,3122119986,'1/05/1981','9/12/2000','1/12/2004','PediatrГ­a');

INSERT INTO MEDICOS (nombre,cedula,sueldo,direccion,telefono,celular,fecha_nacimiento,fecha_grado,fecha_ingreso,especialidad)
VALUES ('CLAUDIA PATRICIA VELEZ','3303796',3240000,'Cr 72 No. 23 - 34',5714057462,3163343456,'1/07/1962','3/08/2001','1/12/2003','PediatrГ­a');
...
INSERT INTO PACIENTES (cedula,nombre,telefono,celular,direccion,fecha_nacimiento,EPS)
VALUES ('71622458', 'GUILLERMO LEON QUIROZ',5712345433,3003214647,'Cr 3 No.42-24','02/03/2001','ColmГ©dica');

INSERT INTO PACIENTES (cedula,nombre,telefono,celular,direccion,fecha_nacimiento,EPS)
VALUES ('70191308', 'FRANCISCO JAVIER PEГ‘A',5713423543,3108456321,'Cr 23 No.42-44','02/03/2001','Humana Vivir');
...
INSERT INTO CONSULTORIOS (especialidad, consultorio)
VALUES('GinecologГ­a','G104');
INSERT INTO CONSULTORIOS (especialidad, consultorio)
VALUES('GinecologГ­a','G105');
INSERT INTO CONSULTORIOS (especialidad, consultorio)
VALUES('GinecologГ­a','G204');
INSERT INTO CONSULTORIOS (especialidad, consultorio)
VALUES('GinecologГ­a','G205');
INSERT INTO CONSULTORIOS (especialidad, consultorio)
VALUES('GinecologГ­a','G206'); 

INSERT INTO CONSULTORIOS (especialidad, consultorio)
VALUES('TraumatologГ­a','T106');
INSERT INTO CONSULTORIOS (especialidad, consultorio)
VALUES('TraumatologГ­a','T107');
INSERT INTO CONSULTORIOS (especialidad, consultorio)
VALUES('TraumatologГ­a','T208');
INSERT INTO CONSULTORIOS (especialidad, consultorio)
VALUES('TraumatologГ­a','T210');

INSERT INTO CONSULTORIOS (especialidad, consultorio)
VALUES('PediatrГ­a','P108');
INSERT INTO CONSULTORIOS (especialidad, consultorio)
VALUES('PediatrГ­a','P109');
INSERT INTO CONSULTORIOS (especialidad, consultorio)
VALUES('PediatrГ­a','P110');
INSERT INTO CONSULTORIOS (especialidad, consultorio)
VALUES('PediatrГ­a','P201');
INSERT INTO CONSULTORIOS (especialidad, consultorio)
VALUES('PediatrГ­a','P309');
